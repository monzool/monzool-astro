...
With its `UsrBin`<sup>[1]</sup> module, often used function like `ls`, `ps` etc. are available.

The `Fitting`<sup>[2]</sup> module emulates common shell behaviors. E.g: redirecting to `/dev/null` can be done
